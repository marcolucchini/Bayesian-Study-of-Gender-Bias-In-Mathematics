...
ggplot() +
  ...
  scale_fill_manual(name = "Legend", labels = c("histogram"), values = c("royalblue3"))+
...
El objetivo principal de nuestro trabajo era poder evaluar cuál es el resultado obtenido por un estudiante de Cataluña en la prueba de evaluación de competencia matemática de cuarto curso de ESO en función de diferentes variables que pudieran intervenir.
\
Nos interesaba especialmente ver si el sexo del estudiante influía o no de forma significativa en la puntuación final obtenida en dicha prueba ya que, de ser así, podríamos afirmar la existencia de un sesgo de género en la materia de matemáticas para la población estudiada.
\
Después de evaluar diferentes modelos y de descartar variables que pensábamos que podían influir en los resultados finales, hemos validado el último modelo como el que mejor explicaría nuestros datos y mejores predicciones podría ofrecer para estimar la puntuación de una persona en la prueba de competencia matemática de Cataluña.
\
Recordamos que toda esta conclusión debe ser explicada en términos de diferencia con el resultado medio ya que nuestros covariados se refieren a la diferencia con la media

* ¿Es el género un factor relevante en el resultado de matemáticas?

Sí lo es, de hecho el coeficiente de sexo muestra que los niños deberían obtener un promedio de 2,5 puntos más que las niñas en el examen.

* ¿Es cierto que las chicas son coherentes en las notas de lenguas y matemáticas mientras que los chicos tienden a tener un comportamiento opuesto?

Sí, el coeficiente de leng4 muestra que para las niñas el resultado de lenguas influencia positivamente el de matemáticas.
Mientras que para los niños la interacción reduce este coeficiente y se vuelve negativo (0.11 - 0.18 = -0.07), por lo que el resultado de matemáticas está inversamente correlacionado con el resultado de lenguas.

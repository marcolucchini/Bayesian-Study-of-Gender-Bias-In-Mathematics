...
We now predict the values of PMAT_4 for the students in the test set and comopare the results.
...
```{r comparison}
# k = density(train$PMAT_4)
# plot(k, type="l", lwd=2, col="red",
#      main="Systolic Blood Pressure Before and After Treatment",
#      xlab = "Systolic Blood Pressure (mmHg)",
#      ylab = "Frequency", yaxt="n",
#      xlim = c(0, 100), density = TRUE)
# hist(y_t, add = TRUE, density = TRUE)
